...
ALTER TABLE bridge
    ADD CONSTRAINT bridge_info_location
...
ALTER TABLE bridge
    ADD CONSTRAINT bridge_material
...
ALTER TABLE image
    ADD CONSTRAINT image_bridge
        FOREIGN KEY (bridge_id)
            REFERENCES bridge (id) ON DELETE CASCADE
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
;

-- Reference: interesting_fact_bridge (table: interesting_fact)
ALTER TABLE interesting_fact
    ADD CONSTRAINT interesting_fact_bridge
        FOREIGN KEY (bridge_id)
